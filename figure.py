...
def plotly_figure_2(data):
    ...
    trace_setosa = go.Scatter3d(
        ...
        opacity=0.7,
        name="Iris-setosa",
        marker={'size': 5, 'color': 'rgba(255,102, 255,0.8)'}
    )
    ...
    trace_versicolor = go.Scatter3d(
        ...
        marker={'size': 5, 'color': 'rgba(102, 255, 51, 0.8)'}
    )
    ...
    trace_virginica = go.Scatter3d(
        ...
        opacity=0.7,
        name="Iris-virginica",
        marker={'size': 5, 'color': 'rgba(51, 102, 255, 0.8)'}
    )
